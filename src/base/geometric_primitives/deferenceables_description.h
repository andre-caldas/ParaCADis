...
namespace DataDescription
{
  ...
  template<>
  class DataWithDescription<FloatPoint3D>
    : public DataWithDescriptionT<FloatPoint3D, "3D point",
                                  {&FloatPoint3D::x, "x"},
                                  {&FloatPoint3D::y, "y"},
                                  {&FloatPoint3D::z, "z"}>
  {};
  ...
  template<>
  class DataWithDescription<FloatVector3D>
    : public DataWithDescriptionT<FloatVector3D, "3D vector",
                                  {&FloatVector3D::x, "x"},
                                  {&FloatVector3D::y, "y"},
                                  {&FloatVector3D::z, "z"}>
  {};
